...
class MyScene extends CGFscene {
    ...
    initLights() {
        this.setGlobalAmbientLight(this.intLight, this.intLight, this.intLight, 1.0);
    ...
    initMaterials() {
        ...
        //this.material4.setDiffuse(140, 53, 32, 1.0);
        this.material4.setDiffuse(0.55, 0.21, 0.13, 1.0);
