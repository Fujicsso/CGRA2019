...
class MyTangram extends CGFobject {
    ...
    this.triangleBig1 = new MyTriangleBig(this.scene, true);
	  this.triangleBig2 = new MyTriangleBig(this.scene);
    this.triangleSmall1 = new MyTriangleSmall(this.scene, true);
    ...
    initMaterials() {
      ...
      this.materialG.setShininess(10.0);
			...
			this.materialTangram.setAmbient(0.5, 0.5, 0.5, 1.0);
      this.materialTangram.setDiffuse(0, 0, 0, 1.0);
      this.materialTangram.setSpecular(1, 1, 1, 1);
